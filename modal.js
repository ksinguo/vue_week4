      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-4">
            ...
            <div>
              <h4>多圖設置</h4>
              <!-- 判斷tempProduct.imagesUrl是陣列再出現資料，若不是陣列之後跑到push方法會出錯 -->
              <div v-if="Array.isArray(tempProduct.imagesUrl)">
                <template v-for="(img,index) in tempProduct.imagesUrl" :key="index + 12">
                  <!-- <input type="text" class="form-control" v-model="img">(不會改到tempProduct.imageUrl的資料，因為讓img指標只到另一個字串而已) -->
                  <input type="text" class="form-control" v-model="tempProduct.imagesUrl[index]">
                  <img :src="img" alt="" class="img-fluid mb-2">
                </template>
